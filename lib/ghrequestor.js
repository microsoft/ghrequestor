 ...
 * @param defaultOptions {object} The base set of options.
 * @param givenOptions {object} The set of options to overlay on the defaults.
...
class Requestor {
  ...
  get(target, options, callback) {
    ...
    return get(target, mergeOptions(this.defaultOptions, options), callback);
  }
  ...
  getAll(target, options, callback) {
    ...
    return getAll(target, mergeOptions(this.defaultOptions, options), callback);
  }

  defaults(options) {
    const newOptions = mergeOptions(this.defaultOptions, options);
    return new Requestor(newOptions);
  }
}

class GHRequestor {
  constructor(givenOptions = {}) {
    this.options = mergeOptions(GHRequestor._defaultOptions, givenOptions);
